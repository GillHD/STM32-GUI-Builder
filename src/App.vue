...
//     });
//     if (selected) {
//       settings.value.projectPath = selected as string;
//     }
//   } catch (e) {
...
// async function selectBuildDirectory() {
//   try {
//     const selected = await open({
//       directory: true,
//       multiple: false,
...
//     });
//     if (selected) {
//       settings.value.buildDir = selected as string;
//     }
//   } catch (e) {
//     console.error('Failed to select build directory:', e);
//   }
// }
...
//     });
//     if (selected) {
//       settings.value.workspacePath = selected as string;
//     }
//   } catch (e) {
...
//       }],
//       multiple: false,
//       title: 'Select STM32CubeIDE Executable'
//     });
//     if (selected) {
//       settings.value.cubeIdeExePath = selected as string;
//     }
//   } catch (e) {
//     console.error('Failed to select IDE executable:', e);
//   }
// }
</script>